...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('classroom_activity', 'title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Activity.title'
        db.alter_column('classroom_activity', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
