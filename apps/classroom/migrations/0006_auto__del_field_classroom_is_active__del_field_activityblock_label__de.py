...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Classroom.is_active'
        db.delete_column('classroom_classroom', 'is_active')

        # Deleting field 'ActivityBlock.label'
        db.delete_column('classroom_activityblock', 'label')

        # Deleting field 'ActivityBlock.date'
        db.delete_column('classroom_activityblock', 'date')

        # Adding field 'ActivityBlock.week'
        db.add_column('classroom_activityblock', 'week',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActivityBlock.weekday_index'
        db.add_column('classroom_activityblock', 'weekday_index',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActivityBlock.heading'
        db.add_column('classroom_activityblock', 'heading',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


        # Changing field 'ActivityBlock.sort_order'
        db.alter_column('classroom_activityblock', 'sort_order', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

    def backwards(self, orm):
        # Adding field 'Classroom.is_active'
        db.add_column('classroom_classroom', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ActivityBlock.label'
        db.add_column('classroom_activityblock', 'label',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'ActivityBlock.date'
        db.add_column('classroom_activityblock', 'date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ActivityBlock.week'
        db.delete_column('classroom_activityblock', 'week')

        # Deleting field 'ActivityBlock.weekday_index'
        db.delete_column('classroom_activityblock', 'weekday_index')

        # Deleting field 'ActivityBlock.heading'
        db.delete_column('classroom_activityblock', 'heading')


        # Changing field 'ActivityBlock.sort_order'
        db.alter_column('classroom_activityblock', 'sort_order', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
    ...
    models = {
        ...
        'classroom.activityblock': {
            ...
            'heading': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
