...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PageDiv.sort_order'
        db.add_column('classroom_pagediv', 'sort_order',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PageDiv.sort_order'
        db.delete_column('classroom_pagediv', 'sort_order')
