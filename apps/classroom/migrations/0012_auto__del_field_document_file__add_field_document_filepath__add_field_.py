...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('classroom_document', 'file')

        # Adding field 'Document.filepath'
        db.add_column('classroom_document', 'filepath',
                      self.gf('django.db.models.fields.FilePathField')(default='', path=u'/home/dave/Repos/github/spot/apps/classroom/content', max_length=100, recursive=True, match=u'.*'),
                      keep_default=False)

        # Adding field 'Document.access_index'
        db.add_column('classroom_document', 'access_index',
    ...
    def backwards(self, orm):
        ...
        db.add_column('classroom_document', 'file',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=100),
                      keep_default=False)

        # Deleting field 'Document.filepath'
        db.delete_column('classroom_document', 'filepath')

        # Deleting field 'Document.access_index'
        db.delete_column('classroom_document', 'access_index')
