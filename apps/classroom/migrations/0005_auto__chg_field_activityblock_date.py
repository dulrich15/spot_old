...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ActivityBlock.date'
        db.alter_column('classroom_activityblock', 'date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'ActivityBlock.date'
        db.alter_column('classroom_activityblock', 'date', self.gf('django.db.models.fields.DateTimeField')(null=True))
