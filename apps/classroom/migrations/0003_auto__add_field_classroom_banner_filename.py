...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Classroom.banner_filename'
        db.add_column('classroom_classroom', 'banner_filename',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Classroom.banner_filename'
        db.delete_column('classroom_classroom', 'banner_filename')
