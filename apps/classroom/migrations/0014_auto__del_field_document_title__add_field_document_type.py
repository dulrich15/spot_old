...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('classroom_document', 'title')

        # Adding field 'Document.type'
        db.add_column('classroom_document', 'type',
    ...
    def backwards(self, orm):
        ...
        db.add_column('classroom_document', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Document.type'
        db.delete_column('classroom_document', 'type')
