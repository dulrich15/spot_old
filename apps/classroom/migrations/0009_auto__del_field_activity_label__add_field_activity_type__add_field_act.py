...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Activity.label'
        db.delete_column('classroom_activity', 'label')
        ...
        # Adding field 'Activity.title'
        db.add_column('classroom_activity', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Activity.label'
        db.add_column('classroom_activity', 'label',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Deleting field 'Activity.type'
        db.delete_column('classroom_activity', 'type')

        # Deleting field 'Activity.title'
        db.delete_column('classroom_activity', 'title')
