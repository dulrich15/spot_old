...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Document.filepath'
        db.alter_column('classroom_document', 'filepath', self.gf('django.db.models.fields.FilePathField')(path=u'/home/dave/Repos/github/spot/content/documents', max_length=100, recursive=True, match=u'.*'))
        # Deleting field 'Activity.type'
        db.delete_column('classroom_activity', 'type_id')

        # Adding field 'Activity.activity_type'
        db.add_column('classroom_activity', 'activity_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['classroom.ActivityType']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Document.filepath'
        db.alter_column('classroom_document', 'filepath', self.gf('django.db.models.fields.FilePathField')(path=u'c:\\Users\\Family\\Documents\\Dave\\Git repos\\github\\spot\\content\\documents', max_length=100, recursive=True, match=u'.*'))
        # Adding field 'Activity.type'
        db.add_column('classroom_activity', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['classroom.ActivityType']),
                      keep_default=False)

        # Deleting field 'Activity.activity_type'
        db.delete_column('classroom_activity', 'activity_type_id')
