...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityType.sort_order'
        db.add_column('classroom_activitytype', 'sort_order',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActivityType.sort_order'
        db.delete_column('classroom_activitytype', 'sort_order')
