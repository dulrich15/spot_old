...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Activity.activity_block'
        db.add_column('classroom_activity', 'activity_block',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['classroom.ActivityBlock']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Activity.activity_block'
        db.delete_column('classroom_activity', 'activity_block_id')
