...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LabProject.activity'
        db.add_column('docmaker_labproject', 'activity',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['classroom.Activity']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LabProject.activity'
        db.delete_column('docmaker_labproject', 'activity_id')
