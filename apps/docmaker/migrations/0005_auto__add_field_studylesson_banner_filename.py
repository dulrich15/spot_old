...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StudyLesson.banner_filename'
        db.add_column('docmaker_studylesson', 'banner_filename',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StudyLesson.banner_filename'
        db.delete_column('docmaker_studylesson', 'banner_filename')
