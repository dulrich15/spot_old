...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExerciseSetModfication.sort_order'
        db.add_column('docmaker_exercisesetmodfication', 'sort_order',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExerciseSetModfication.sort_order'
        db.delete_column('docmaker_exercisesetmodfication', 'sort_order')
