...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ExerciseSet.title2'
        db.delete_column('docmaker_exerciseset', 'title2')

        # Adding field 'ExerciseSet.title'
        db.add_column('docmaker_exerciseset', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Deleting field 'StudyLesson.title2'
        db.delete_column('docmaker_studylesson', 'title2')

        # Adding field 'StudyLesson.title'
        db.add_column('docmaker_studylesson', 'title',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=200),
                      keep_default=False)

        # Deleting field 'LabProject.title2'
        db.delete_column('docmaker_labproject', 'title2')

        # Adding field 'LabProject.title'
        db.add_column('docmaker_labproject', 'title',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ExerciseSet.title2'
        db.add_column('docmaker_exerciseset', 'title2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Deleting field 'ExerciseSet.title'
        db.delete_column('docmaker_exerciseset', 'title')

        # Adding field 'StudyLesson.title2'
        db.add_column('docmaker_studylesson', 'title2',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=200),
                      keep_default=False)

        # Deleting field 'StudyLesson.title'
        db.delete_column('docmaker_studylesson', 'title')

        # Adding field 'LabProject.title2'
        db.add_column('docmaker_labproject', 'title2',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=200),
                      keep_default=False)

        # Deleting field 'LabProject.title'
        db.delete_column('docmaker_labproject', 'title')
