...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExerciseSetProblem'
        db.create_table('docmaker_exercisesetproblem', (
            ...
            ('regex_pattern', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('regex_replace', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal('docmaker', ['ExerciseSetProblem'])
    ...
    def backwards(self, orm):
        # Deleting model 'ExerciseSetProblem'
        db.delete_table('docmaker_exercisesetproblem')
    ...
    models = {
        ...
        'docmaker.exerciseset': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'problems': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['docmaker.ExerciseProblem']", 'symmetrical': 'False', 'through': "orm['docmaker.ExerciseSetProblem']", 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'})
        },
        'docmaker.exercisesetproblem': {
            'Meta': {'ordering': "[u'exercise_set', u'sort_order']", 'object_name': 'ExerciseSetProblem'},
            ...
            'regex_pattern': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'regex_replace': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
