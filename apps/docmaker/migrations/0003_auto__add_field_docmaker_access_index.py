...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Docmaker.access_index'
        db.add_column('docmaker_docmaker', 'access_index',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Docmaker.access_index'
        db.delete_column('docmaker_docmaker', 'access_index')
