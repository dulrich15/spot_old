...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StudyLesson.powerpoint'
        db.add_column('docmaker_studylesson', 'powerpoint',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StudyLesson.powerpoint'
        db.delete_column('docmaker_studylesson', 'powerpoint')
