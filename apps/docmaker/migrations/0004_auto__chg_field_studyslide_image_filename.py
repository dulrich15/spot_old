...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StudySlide.image_filename'
        db.alter_column('docmaker_studyslide', 'image_filename', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'StudySlide.image_filename'
        db.alter_column('docmaker_studyslide', 'image_filename', self.gf('django.db.models.fields.CharField')(default=2, max_length=200))
