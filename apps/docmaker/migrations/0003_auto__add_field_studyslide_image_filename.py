...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StudySlide.image_filename'
        db.add_column('docmaker_studyslide', 'image_filename',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StudySlide.image_filename'
        db.delete_column('docmaker_studyslide', 'image_filename')
    ...
    models = {
        ...
        'docmaker.studyslide': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_filename': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
