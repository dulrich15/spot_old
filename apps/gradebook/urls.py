...
#     url(r'^classroom/(\d+)/assignment/(\d+)/$', views.show_assignments, name='show_assignment'),

#     url(r'^classroom/(\d+)/grades/$', views.show_grades, name='show_grades'),

#     url(r'^courses/(\d+)/grades/students/$', views.list_students, name='list_students'),
#     url(r'^courses/(\d+)/grades/students/edit/$', views.edit_student_list, name='edit_student_list'),
#     url(r'^courses/(\d+)/grades/students/(\d+)/$', views.show_student, name='show_student'),
#
